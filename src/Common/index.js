    ...
    <div className="lg:px-6 xl:px-0 h-full md:h-screen p-3 md:pt-4 snap-center" style={{backgroundColor:'#014022'}}>
                <div className="mx-auto container px-4 xl:px-0 ">
                    <div className="flex flex-col-reverse md:flex-row">
                        ...
                        <div className="md:w-1/2 sm:w-2/5 h-144 md:h-auto m-auto flex items-center overflow-hidden">
            ...
            <div className="lg:px-6 xl:px-0 h-full md:h-screen p-3  md:pt-2 snap-center" style={{backgroundColor:'#57DB5A'}}>
                <div className="mx-auto container px-4 xl:px-0">
                    <div className="flex flex-col-reverse md:flex-row">
                        <div className="md:w-9/12 md:pt-4 pb-10 lg:py-8 xl:py-12">
                            <h1 className="text-2xl lg:text-4xl xl:text-8xl font-black text-gray-900 text-center md:text-left tracking-tighter f-f-i md:w-9/14 leading-tight text-heading-color">
                ...
                <div className="mx-auto container px-4 xl:px-0">
                    <div className="flex flex-col-reverse md:flex-row">
                        <div className="md:w-3/5 md:pt-4 pb-10 lg:py-8 xl:py-12">
                            ...
                            <h2 className="md:w-9/14 py-4 text-center md:text-left md:py-8 text-gray-700 text-lg lg:text-2xl">Other crypto exchanges charge up to 4% just to buy and sell crypto. We charge 0%. Get BTC, ETH, LTC, DOGE, and more with as little as $1.</h2>
                            <div className="w-full flex justify-center md:block">
